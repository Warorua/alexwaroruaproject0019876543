        ...
        <div class="d-flex align-items-stretch flex-shrink-0">
            ...
            <div class="d-flex align-items-center ms-1 ms-lg-3">
                ...
                <a href="../v1/messages" class="btn btn-icon btn-danger position-relative w-30px h-30px w-md-40px h-md-40px">
                    <!--begin::Svg Icon | path: /var/www/preview.kotnova.sbnke.com/kt-products/docs/metronic/html/releases/2022-10-09-043348/core/html/src/media/icons/duotune/communication/com007.svg-->
